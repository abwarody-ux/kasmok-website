  ...
  return (
    <div className="min-h-screen bg-[#0a0d14] text-white overflow-x-hidden">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-2">
        ...
        <a href={"https://wa.me/?text=" + encodeURIComponent("KASMOK Digital — Gaming Room Management — Gerez votre salle de jeux PS4/PS5 en RDC avec KASMOK Digital " + (typeof window !== 'undefined' ? window.location.href : ''))}
          target="_blank" rel="noopener noreferrer"
        ...
        <a href={"https://twitter.com/intent/tweet?text=" + encodeURIComponent("KASMOK Digital — Gaming Room Management — Gerez votre salle de jeux PS4/PS5 en RDC avec KASMOK Digital") + "&url=" + encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}
          target="_blank" rel="noopener noreferrer"
